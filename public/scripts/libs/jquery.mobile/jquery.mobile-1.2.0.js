		...
		setup: function() {
			...
			$this.bind( "vmousedown", function( event ) {
				var data = event.originalEvent.touches ?
				 	...
				 	start = { }, stop;
				$.event.special.tap.pageX = data.pageX;
				$.event.special.tap.pageY = data.pageY;
				...
				timer = setTimeout( function() {
					triggerCustomEvent( thisObject, "taphold", event /*$.Event( "taphold", { target: origTarget } )*/ );
...
$.widget( "mobile.checkboxradio", $.mobile.widget, {
	...
	refresh: function() {
		...
		if ( input.checked ) {
			...
			label.parent().parent().addClass( this.checkedClass ).removeClass( this.uncheckedClass );
			icon.addClass( this.checkedicon ).removeClass( this.uncheckedicon );
		} else {
			label.removeClass( this.checkedClass ).addClass( this.uncheckedClass );
			label.parent().parent().removeClass( this.checkedClass ).addClass( this.uncheckedClass );
